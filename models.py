...
class Grupo(db.Model):
    ...
    tipo = db.Column(db.String(30), default="publico")
    status_pagamento = db.Column(db.String(30), default="gratuito")
    limite_participantes = db.Column(db.Integer, default=150)
    preco_centavos = db.Column(db.Integer, default=4990)
    plataforma_pagamento = db.Column(db.String(30))
    produto_pagamento = db.Column(db.String(100))
    compra_token_hash = db.Column(db.String(255))
...
class User(db.Model):
    ...
    time_destaque = db.Column(db.String(5))
    created_at = db.Column(db.DateTime, default=datetime.utcnow)
    updated_at = db.Column(db.DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)
...
class Jogo(db.Model):
    ...
    sigla_time_a = db.Column(db.String(20))
    sigla_time_b = db.Column(db.String(20))
