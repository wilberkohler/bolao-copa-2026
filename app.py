...
TRANSLATIONS = {
    "pt-BR": {
        ...
        "private_group_price_note": "O preco final sera exibido pela Apple ou Google Play no momento da compra. A compra nao envolve apostas, premios em dinheiro ou movimentacao financeira entre usuarios.",
        ...
        "private_group_no_gambling": "Este aplicativo nao oferece apostas, premios em dinheiro, carteira, saque, deposito ou odds. Os palpites servem apenas para ranking recreativo.",
    ...
    "en": {
        ...
        "private_group_price_note": "The final price will be shown by Apple or Google Play at purchase time. The purchase does not involve betting, cash prizes, or money movement between users.",
        ...
        "private_group_no_gambling": "This app does not offer betting, cash prizes, wallets, deposits, withdrawals, or odds. Predictions are only used for recreational rankings.",
...
TRANSLATIONS["es"].update({
    ...
    "private_group_price_note": "El precio final sera mostrado por Apple o Google Play al comprar. La compra no incluye apuestas, premios en dinero ni movimiento financiero entre usuarios.",
    ...
    "private_group_participants": "Participantes",
    "private_group_no_gambling": "Esta app no ofrece apuestas, premios en dinero, billetera, depositos, retiros ni cuotas. Los pronosticos solo se usan para rankings recreativos.",
...
TRANSLATIONS["fr"].update({
    ...
    "private_group_price_note": "Le prix final sera affiche par Apple ou Google Play au moment de l'achat. L'achat n'implique ni paris, ni prix en argent, ni mouvement d'argent entre utilisateurs.",
    ...
    "private_group_participants": "Participants",
    "private_group_no_gambling": "Cette app ne propose pas de paris, prix en argent, portefeuille, depots, retraits ou cotes. Les pronostics servent uniquement a des classements recreatifs.",
...
TRANSLATIONS["de"].update({
    ...
    "private_group_price_note": "Der endgueltige Preis wird beim Kauf von Apple oder Google Play angezeigt. Der Kauf beinhaltet keine Wetten, Geldpreise oder Geldbewegungen zwischen Nutzern.",
    ...
    "private_group_no_gambling": "Diese App bietet keine Wetten, Geldpreise, Wallets, Einzahlungen, Auszahlungen oder Quoten. Tipps dienen nur der Freizeit-Rangliste.",
...
TRANSLATIONS["it"].update({
    ...
    "private_group_price_note": "Il prezzo finale sara mostrato da Apple o Google Play al momento dell'acquisto. L'acquisto non include scommesse, premi in denaro o movimenti di denaro tra utenti.",
    ...
    "private_group_no_gambling": "Questa app non offre scommesse, premi in denaro, wallet, depositi, prelievi o quote. I pronostici servono solo per classifiche ricreative.",
